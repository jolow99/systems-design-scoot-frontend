...
export default function AdminSection() {
    ...
    return (
        <div>
            ...
            <a href="https://therichpost.com" class="btn w-full btn-primary text-truncate rounded-0 py-2 border-0 position-relative" style={{zIndex: 1000}}> <strong>For more admin teplates:</strong> The design system for Bootstrap 5. Browse all →
            </a>
