...
const FilterBar = ({className, onSearch}) => {
  ...
  return (
  <div className={`filter-bar bg-gray-50 p-4 rounded-lg shadow w-full ${className}`}>
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <fieldset className="space-y-1">
        <legend className="font-semibold text-gray-700">Include IATCI Flights?</legend>
      ...
      <fieldset className="space-y-1">
        <legend className="font-semibold text-gray-700">Show Passenger Names</legend>
        <div className="flex items-center space-x-2">
          <label className="flex items-center space-x-2">
            <input
              type="radio"
